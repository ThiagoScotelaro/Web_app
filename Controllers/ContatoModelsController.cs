...
namespace Contact_Management_Web_application.Controllers
{
    public class ContatoModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Telefone")] ContatoModel contatoModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Telefone")] ContatoModel contatoModel)
        {
